...
export const FeedShell = (): ReactElement => {
  ...
  // Estado vacío - mostrar layout completo con StoriesBar y SuggestedUsers
          ...
          <div className="flex items-start gap-6 lg:gap-8 justify-center">
            ...
            <div className="w-full max-w-sm">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }}
                className="flex flex-col items-center gap-6 rounded-2xl glass-card p-8 mb-8 shadow-elegant-lg"
              >
                <motion.div 
                  className="relative"
                  ...
                  <div className="relative">
                    ...
                    <div className="relative rounded-2xl glass-card p-8 text-center max-w-md shadow-elegant-lg">
                      <div className="mb-4 flex justify-center">
                        <div className="size-16 rounded-full border-2 border-primary-500/30 bg-gradient-to-br from-slate-100 dark:from-slate-900/50 to-white dark:to-black/50 backdrop-blur-sm flex items-center justify-center shadow-elegant">
