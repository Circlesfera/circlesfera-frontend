...
export default function ProtectedLayout({ children }: ProtectedLayoutProps): ReactElement {
  return (
    <div className="relative flex min-h-screen bg-background text-foreground">
      ...
      <div className="pointer-events-none fixed inset-0 bg-hero-grid bg-[length:80px_80px] opacity-[0.08]" aria-hidden />
      ...
      {/* Contenido principal */}
      <main className="relative z-10 flex-1 md:ml-[260px] pb-20 md:pb-0 bg-background/70 md:bg-transparent">
