  ...
  return (
    <main className="flex min-h-screen flex-col">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
        {/* Header con card */}
        <div className="mb-8 rounded-2xl glass-card p-6 md:p-8 animate-fade-in border border-white/5 shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
          ...
          <p className="text-sm md:text-base text-slate-400/80 ml-[52px]">
