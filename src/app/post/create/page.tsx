    ...
    <ProtectedRoute>
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100">
              Crear publicación
            </h1>
        ...
        <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 dark:border-gray-700 overflow-hidden">
