...
export default function LandingPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 dark:bg-gray-900 flex items-center justify-center">
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 dark:from-gray-900 via-white dark:via-gray-900 to-blue-50">
        {/* Navegación */}
        <nav className="border-b border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/80 backdrop-blur-lg sticky top-0 z-50 shadow-sm dark:shadow-gray-900/50">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-5 py-2 rounded-lg font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 transition-all duration-200 hidden sm:block">
                  Iniciar Sesión
                </button>
                <button
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-[1.1] text-gray-900 dark:text-gray-100 dark:text-gray-100 px-4">
                Crea, comparte e{' '}
              ...
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 dark:text-gray-500 max-w-3xl mx-auto mb-10 leading-relaxed px-4">
                ...
                <span className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100">se escuche en el mundo</span>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 px-4">
                ...
                <motion.button
                  ...
                  className="px-8 py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:border-gray-600 bg-white dark:bg-gray-900 dark:bg-gray-900 text-gray-900 dark:text-gray-100 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-800 dark:bg-gray-800 hover:border-gray-400 dark:border-gray-500 transition-all duration-200 font-semibold text-base sm:text-lg w-full sm:w-auto shadow-sm dark:shadow-gray-900/50 hover:shadow-md">
                  Ver Características →
                </motion.button>
              </div>
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative rounded-2xl border-2 border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-white dark:bg-gray-900 dark:bg-gray-900 p-3 shadow-2xl">
                    <div className="rounded-xl bg-gradient-to-br from-gray-50 dark:from-gray-900 to-gray-100 p-3">
                      ...
                      <div className="aspect-video rounded-lg relative overflow-hidden flex items-center justify-center bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 shadow-inner">
                        ...
                        <motion.div
                          ...
                          className="absolute top-6 left-6 flex items-center gap-2 text-white bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
                        ...
                        <motion.div
                          ...
                          whileTap={{ scale: 0.9 }}
                          className="relative z-10 w-20 h-20 rounded-full bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/95 backdrop-blur-sm flex items-center justify-center text-4xl shadow-xl cursor-pointer group">
        ...
        {/* Features */}
        <section id="features" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-24 bg-white dark:bg-gray-900 dark:bg-gray-900">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 sm:mb-20">
              ...
              >
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-900 dark:text-gray-100 dark:text-gray-100 px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -8 }}
                  className="relative rounded-2xl border-2 border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-white dark:bg-gray-900 dark:bg-gray-900 p-6 sm:p-8 shadow-sm dark:shadow-gray-900/50 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 group overflow-hidden"
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-gray-100 dark:text-gray-100 group-hover:text-blue-600 transition-colors">{feature.title}</h3>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="rounded-3xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-gradient-to-br from-gray-50 dark:from-gray-900 to-white p-12 shadow-xl"
            >
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="flex-1">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-gray-900 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 dark:border-gray-700 shadow-sm dark:shadow-gray-900/50 mb-6">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-gray-100 dark:text-gray-100">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-gray-900 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 dark:border-gray-700">
                      <span>✓</span>
        ...
        <section id="cta" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-24 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="relative rounded-3xl border-2 border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-white dark:bg-gray-900 dark:bg-gray-900 p-8 sm:p-12 lg:p-16 text-center shadow-2xl overflow-hidden"
            >
              {/* Gradient overlay */}
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-gray-100 dark:text-gray-100">
                  Únete a la{' '}
                  <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                    revolución
                  </span>
        ...
        {/* Footer */}
        <footer className="border-t-2 border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-gradient-to-b from-white to-gray-50 dark:to-gray-900 px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="pt-8 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 text-center">
