    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm border border-gray-200">
            <Users className="w-10 h-10 text-blue-500 mb-4" />
            <h4 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Comunidad</h4>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <h4 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Creatividad</h4>
            <p className="text-gray-600">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <h4 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Privacidad</h4>
            <p className="text-gray-600">
        ...
        {/* Historia */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 mb-8 shadow-sm border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Nuestra Historia</h3>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 mb-12 border border-blue-200">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Estado Actual</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center">
                <span className="text-2xl font-bold text-white">🚀</span>
              </div>
              <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-2">En Desarrollo</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Plataforma en fase de construcción</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Próximamente</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Primeros usuarios en camino</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center">
                <span className="text-2xl font-bold text-white">💡</span>
              </div>
              <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Innovación</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Tecnología de vanguardia</p>
            </div>
          </div>
        </div>

        {/* Equipo */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-sm border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Nuestro Equipo</h3>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-1">Desarrollo</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Innovación técnica</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-1">Diseño</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Experiencia de usuario</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="font-bold text-gray-900 dark:text-gray-100 mb-1">Comunidad</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Crecimiento y engagement</p>
            </div>
          </div>
        </div>
