        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Búsqueda vacía</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {loading ? (
            <div className="space-y-4">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="bg-white dark:bg-gray-900 rounded-xl shadow-md border border-gray-100 p-4 animate-pulse">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md border border-gray-100 p-8 text-center">
              <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Error en la búsqueda</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md border border-gray-100 p-8 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No se encontraron resultados</h3>
              <p className="text-gray-600">
            ...
            <div className="space-y-4">
              ...
              {results.map((user) => (
                <Link
                  key={user._id}
                  href={`/${user.username}`}
                  className="block bg-white dark:bg-gray-900 rounded-xl shadow-md border border-gray-100 p-4 hover:shadow-lg transition-shadow"
                >
                  <div className="flex items-center space-x-4">
                    {user.avatar ? (
                      <Image
