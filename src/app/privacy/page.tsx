  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800 dark:bg-gray-800">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Cookies */}
        <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-2xl p-8 mb-8 shadow-sm dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 dark:border-gray-700">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">Uso de Cookies</h3>
          <div className="text-gray-700 dark:text-gray-300 space-y-4">
            <p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">Cookies Esenciales</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">
                  Necesarias para el funcionamiento básico de la plataforma
                </p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">Cookies de Rendimiento</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">
                  Nos ayudan a entender cómo usas la plataforma
                </p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">Cookies de Funcionalidad</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">
        ...
        <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-2xl p-8 mb-8 shadow-sm dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 dark:border-gray-700">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">Compartir Información</h3>
          <div className="text-gray-700 dark:text-gray-300 space-y-4">
            <p>
        ...
        {/* Retención de datos */}
        <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-2xl p-8 mb-8 shadow-sm dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 dark:border-gray-700">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">Retención de Datos</h3>
          <div className="text-gray-700 dark:text-gray-300 space-y-4">
            <p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">Cuenta activa</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">
                  Mantenemos tu información mientras tu cuenta esté activa
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">Después de eliminar cuenta</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">
