        ...
        <div className="max-w-7xl mx-auto h-[calc(100vh-88px)] p-2 sm:p-4">
          <div className="backdrop-blur-xl bg-white dark:bg-gray-900/90 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700/50 overflow-hidden h-full">
            <div className="flex h-full">
              {/* Sidebar mejorado */}
              <div className={`${showChat ? 'hidden md:block' : 'block'} w-full md:w-96 lg:w-[420px] border-r border-gray-200 dark:border-gray-700/50 bg-gradient-to-b from-gray-50 dark:from-gray-900/50 to-white/50`}>
                <ConversationsList
