...
export default function ModernProfileTabs({ username, isOwnProfile }: ModernProfileTabsProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-white dark:bg-gray-900/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 dark:border-gray-700/50 overflow-hidden">
        {/* Pestañas mejoradas */}
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 px-4 py-4 text-sm font-medium transition-all duration-300 relative ${activeTab === tab.id
                  ...
                  : 'text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:bg-gray-800/50'
                  }`}
              >
                {activeTab === tab.id && (
      ...
      {safeContent.map((item) => {
        ...
        return (
          <div
            ...
            className="aspect-[9/16] rounded-2xl lg:rounded-3xl overflow-hidden bg-gray-100 dark:bg-gray-800 relative group cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
          >
            <div className="absolute inset-0">
              {type === 'posts' ? (
                <Image
            ...
            {type === 'reels' && (
              <>
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="w-12 h-12 bg-white dark:bg-gray-900/90 rounded-full flex items-center justify-center">
