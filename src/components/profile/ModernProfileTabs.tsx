            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 px-4 py-4 text-sm font-medium transition-all duration-300 relative ${activeTab === tab.id
                  ...
                  : 'text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-800 dark:bg-gray-800/50'
                  }`}
              >
                {activeTab === tab.id && (
                  <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500"></div>
                )}
                <div className={`transition-colors duration-300 ${activeTab === tab.id ? 'text-blue-600' : 'text-gray-500 dark:text-gray-400 dark:text-gray-500'}`}>
                  {tab.icon}
                </div>
                ...
                <span
                  ...
                  className={`px-2 py-1 rounded-full text-xs font-bold transition-all duration-300 cursor-pointer hover:scale-105 ${activeTab === tab.id
                    ...
                    : 'bg-gray-100 dark:bg-gray-700 dark:bg-gray-800 text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-600 dark:bg-gray-600'
