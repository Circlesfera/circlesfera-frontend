            ...
            <div className="flex items-center justify-center sm:justify-start gap-2">
              ...
              {isOwnProfile && (
                <>
                  <button
                    onClick={onEditClick}
                    className="px-3 sm:px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:bg-gray-700 text-xs sm:text-sm font-semibold border border-gray-200 dark:border-gray-700 transition-all duration-200 shadow-sm dark:shadow-gray-900/50 hover:shadow-md flex items-center gap-1 sm:gap-2"
                  >
                  ...
                  <Link
                    href="/settings"
                    className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:bg-gray-700 transition-all duration-200 shadow-sm dark:shadow-gray-900/50 hover:shadow-md"
                    title="Configuración"
                  >
