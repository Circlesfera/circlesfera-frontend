  ...
  return (
    <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-none sm:rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-4 sm:p-6 mb-6 sm:mb-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        {user.location && (
          <div className="flex items-center gap-3">
            <LocationIcon className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 dark:text-gray-400 dark:text-gray-500" />
            <span className="text-xs sm:text-sm text-gray-700 dark:text-gray-300">{user.location}</span>
          </div>
        )}
        ...
        {isOwnProfile && user.birthDate && (
          <div className="flex items-center gap-3">
            <CalendarIcon className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 dark:text-gray-400 dark:text-gray-500" />
        ...
        {user.website && (
          <div className="flex items-center gap-3">
            <LinkIcon className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 dark:text-gray-400 dark:text-gray-500" />
            <a 
