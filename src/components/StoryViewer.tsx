    ...
    return (
      <div className="fixed inset-0 bg-black z-50 flex items-center justify-center">
        <div className="text-white text-center">
          ...
          <button
            onClick={handleClose}
            className="px-4 py-2 bg-white dark:bg-gray-900 dark:bg-gray-900 text-black rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 transition-colors"
          >
            Cerrar
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 story-viewer">
      ...
      <div className="absolute top-0 left-0 right-0 h-1 bg-gray-800 z-10">
        <div
          className="h-full bg-white dark:bg-gray-900 dark:bg-gray-900 transition-all duration-100 ease-linear"
          ...
          {showMoreMenu && (
            <div className="absolute bottom-16 right-0 w-48 bg-black/90 backdrop-blur-sm rounded-lg shadow-xl border border-white/10 z-50">
              ...
              <button
                ...
                className="w-full px-4 py-3 text-left text-gray-300 hover:bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/10 transition-colors rounded-lg flex items-center space-x-3"
              >
                <ReportIcon />
                <span>Reportar</span>
              </button>
      ...
      {showReplyInput && (
        <div className="absolute bottom-8 left-4 right-4 flex items-center space-x-2">
          <input
            ...
            className="flex-1 bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/95 backdrop-blur-sm rounded-full px-4 py-3 text-gray-900 dark:text-gray-100 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 dark:placeholder-gray-500 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            maxLength={200}
          />
          <button
            onClick={handleReply}
