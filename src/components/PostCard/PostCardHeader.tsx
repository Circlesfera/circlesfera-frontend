...
export function PostCardHeader({
  ...
  const menuId = `post-menu-${post._id}`
    ...
    <div className="flex items-center justify-between px-6 py-3">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          <div className="flex items-center space-x-2">
            <button
              onClick={() => onUserClick?.(post.user._id)}
              className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 text-sm hover:text-blue-600 transition-colors focus-visible:outline-none focus-visible:underline truncate max-w-[150px]"
              {...getButtonA11yProps(ARIA_LABELS.user.profile(post.user.username))}
            >
              {post.user.username}
            </button>
      ...
      <div className="relative" ref={moreMenuRef}>
        <button
          ...
          className="min-w-[44px] min-h-[44px] p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
        ...
        {showMore && (
          <div
            ...
            className="absolute right-0 top-full mt-1 w-56 bg-white dark:bg-gray-900 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl shadow-xl z-50 py-1 animate-fade-in"
          >
            {isOwner ? (
              <>
                ...
                <button
                  ...
                  className="w-full px-4 py-3 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-800 dark:bg-gray-800 flex items-center space-x-3 transition-colors focus-visible:outline-none focus-visible:bg-gray-100 dark:bg-gray-700 dark:bg-gray-700"
                  role="menuitem"
