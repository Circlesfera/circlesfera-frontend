  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
      <div className="p-6 border-b border-gray-100 dark:border-gray-700">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Descubre el contenido más reciente de la comunidad</p>
      </div>
      ...
      <div className="p-6">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">Cuando los usuarios compartan contenido, aparecerá aquí.</p>
          </div>
        ) : (
