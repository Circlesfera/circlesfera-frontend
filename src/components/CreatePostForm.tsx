            ...
            <div className="flex space-x-4">
              ...
              >
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <div className="text-center">
                    <div className={`font-semibold ${aspectRatio === '1:1' ? 'text-blue-700' : 'text-gray-700 dark:text-gray-300 dark:text-gray-300'}`}>
                      Cuadrado
                    </div>
              ...
              >
                <div className="flex flex-col items-center space-y-2">
                  ...
                  />
                  <div className="text-center">
                    <div className={`font-semibold ${aspectRatio === '4:5' ? 'text-blue-700' : 'text-gray-700 dark:text-gray-300 dark:text-gray-300'}`}>
                      Vertical
                    </div>
            ...
            {!preview ? (
              <div
                className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${isDragOver
                  ...
                  : 'border-gray-300 dark:border-gray-600 dark:border-gray-600 hover:border-gray-400 dark:border-gray-500'
                  }`}
