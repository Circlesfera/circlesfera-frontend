  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-semibold text-gray-900 dark:text-white text-sm">Sugerencias para ti</h3>
        <button className="text-xs font-semibold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
          Ver todo
        </button>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
        <div className="text-gray-400 dark:text-gray-500 text-xs">
          ...
          <div className="text-center mt-3">
            <span>© 2024 </span>
            <span className="font-semibold text-gray-600 dark:text-gray-400">CircleSfera</span>
