                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                  {post.content.images.map((_, index) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition-all duration-200 ${index === currentImageIndex ? 'bg-white dark:bg-gray-900 dark:bg-gray-900' : 'bg-white dark:bg-gray-900 dark:bg-gray-900/50'
                        }`}
                    />
                  ))}
                </div>
      ...
      <div className="flex items-center justify-between px-6 py-1">
        ...
        <div className="relative" ref={moreMenuRef}>
          <button
            ...
            className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 transition-all duration-200"
          >
            <MoreIcon />
          </button>
