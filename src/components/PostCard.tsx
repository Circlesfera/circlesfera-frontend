                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                  {post.content.images.map((_, index) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition-all duration-200 ${index === currentImageIndex ? 'bg-white dark:bg-gray-900' : 'bg-white dark:bg-gray-900/50'
                        }`}
                    />
                  ))}
                </div>
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/10">
                <div className="bg-white dark:bg-gray-900/90 rounded-full p-3 backdrop-blur-sm">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center space-x-2">
              <button
                onClick={() => onUserClick?.(post.user._id)}
                className="font-semibold text-gray-900 dark:text-gray-100 text-sm hover:text-blue-600 transition-colors"
              >
                {post.user.username}
              </button>
              {isPinned && (
        ...
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 group hover:scale-105"
            >
              <CommentIcon />
            </button>
                ...
                {post.caption.length > 80 ? (
                  <>
                    ...
                    <button
                      ...
                      className="text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 ml-1 font-medium"
                    >
