                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                  {post.content.images.map((_, index) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition-all duration-200 ${index === currentImageIndex ? 'bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900' : 'bg-white dark:bg-gray-900 dark:bg-gray-900/50'
                        }`}
                    />
                  ))}
                </div>
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/10">
                <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/90 rounded-full p-3 backdrop-blur-sm">
                  <svg className="w-6 h-6 text-gray-900 dark:text-gray-100 dark:text-gray-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      case 'text':
        return (
          <div className="px-4 py-3 bg-gradient-to-r from-blue-50 to-purple-50">
            <div className="text-gray-900 dark:text-gray-100 dark:text-gray-100 text-base leading-relaxed whitespace-pre-wrap">
              {post.content.text}
            </div>
          </div>
        );
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-1">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center space-x-2">
              <button
                onClick={() => onUserClick?.(post.user._id)}
                className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 text-sm hover:text-blue-600 transition-colors"
              >
                {post.user.username}
              </button>
              {isPinned && (
        ...
        <div className="relative" ref={moreMenuRef}>
          <button
            ...
            className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 transition-all duration-200"
          >
            <MoreIcon />
          </button>
          ...
          {/* Menú desplegable */}
          {showMore && (
            <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-gray-900 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-lg shadow-lg z-10">
              <div className="py-1">
      ...
      <div className="px-6 py-1">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 transition-all duration-200 group hover:scale-105"
            >
              <CommentIcon />
            </button>
        ...
        {(post.likes.length > 0 || post.caption) && (
          <div className="mb-1">
            {post.likes.length > 0 && (
              <span className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 text-sm mr-3">
            ...
            {isEditing && (
              <div className="mt-2">
                <textarea
                  ...
                  className="w-full p-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-lg text-sm resize-none"
                  rows={3}
        ...
        {post.tags && post.tags.length > 0 && (
          <div className="flex items-center space-x-1 mb-1">
            ...
            <div className="flex flex-wrap gap-1">
              ...
              {post.tags.length > 3 && (
                <span className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-xs">+{post.tags.length - 3}</span>
              )}
            </div>
          </div>
        )}
          ...
          <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-lg p-6 max-w-sm mx-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-4 py-2 bg-gray-300 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancelar
              </button>
            </div>
