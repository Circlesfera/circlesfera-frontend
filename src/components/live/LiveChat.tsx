...
export function LiveChat({
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50 flex flex-col h-96">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-t-lg">
        <div className="flex items-center space-x-2">
          <div className="flex items-center space-x-1">
            ...
            <span className="text-sm font-medium text-gray-900 dark:text-gray-100">EN VIVO</span>
          </div>
        ...
        {!allowComments ? (
          ...
          <form onSubmit={handleSendMessage} className="flex items-center space-x-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:text-gray-400 dark:text-gray-500"
              maxLength={500}
            />
            <button
              type="submit"
