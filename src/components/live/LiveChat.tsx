...
export function LiveChat({
      ...
      <div className="fixed bottom-4 right-4 z-50">
        ...
        >
          ...
          <span className="text-sm font-medium">
            {comments.length > 0 && (
              <span className="bg-white dark:bg-gray-900 dark:bg-gray-900 text-red-600 rounded-full px-2 py-1 text-xs ml-1">
                {comments.length}
              </span>
            )}
          </span>
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 z-50 flex flex-col h-96">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 dark:bg-gray-800 rounded-t-lg">
        <div className="flex items-center space-x-2">
          <div className="flex items-center space-x-1">
            <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
            <span className="text-sm font-medium text-gray-900 dark:text-gray-100 dark:text-gray-100">EN VIVO</span>
          </div>
          <div className="flex items-center space-x-1 text-gray-600 dark:text-gray-400 dark:text-gray-500">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 dark:text-gray-300 transition-colors"
          >
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
        {loading && comments.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm">Cargando comentarios...</div>
          </div>
        ) : error ? (
          <div className="flex items-center justify-center h-full">
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm text-center">
      ...
      {/* Input */}
      <div className="p-3 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700">
        {!allowComments ? (
          <div className="text-center text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm py-2">
          ...
          <form onSubmit={handleSendMessage} className="flex items-center space-x-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 dark:text-gray-100 placeholder:text-gray-500 dark:text-gray-400 dark:text-gray-500"
              maxLength={500}
            />
            <button
              type="submit"
