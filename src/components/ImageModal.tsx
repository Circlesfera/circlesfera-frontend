    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 p-2 bg-white dark:bg-gray-900/10 hover:bg-white dark:bg-gray-900/20 rounded-full transition-colors backdrop-blur-sm z-10"
          >
          ...
          {/* Controles de zoom */}
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex items-center space-x-4 bg-white dark:bg-gray-900/10 backdrop-blur-sm rounded-full px-4 py-2">
            <button
              onClick={handleZoomOut}
              disabled={scale <= 1}
              className="p-2 hover:bg-white dark:bg-gray-900/20 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
