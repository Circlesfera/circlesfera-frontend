          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className={`p-2 rounded-full transition-colors ${isLiked
                ...
                : 'bg-gray-100 dark:bg-gray-700 dark:bg-gray-800 text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:bg-red-100 hover:text-red-600'
                }`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors ${isSaved
                ...
                : 'bg-gray-100 dark:bg-gray-700 dark:bg-gray-800 text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:bg-blue-100 hover:text-blue-600'
                }`}
            >
