...
export default function ChatWindow({ conversationId, conversationName, participants }: ChatWindowProps) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white dark:bg-gray-900 rounded-none md:rounded-r-2xl shadow-lg">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700/50 bg-gradient-to-r from-white to-gray-50 dark:to-gray-900/50 backdrop-blur-sm">
        <button
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700/50 bg-gradient-to-t from-white to-gray-50 dark:to-gray-900/50 backdrop-blur-sm">
