        ...
        <div className={`max-w-[85%] sm:max-w-xs lg:max-w-md ${isOwnMessage ? 'order-2' : 'order-1'}`}>
          ...
          <div className={`relative group ${isOwnMessage ? 'ml-auto' : 'mr-auto'}`}>
            ...
            <div className={`px-3 sm:px-4 py-2 rounded-2xl shadow-sm dark:shadow-gray-900/50 ${isOwnMessage
              ...
              : 'bg-white dark:bg-gray-900 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 dark:border-gray-700 text-gray-900 dark:text-gray-100 dark:text-gray-100'
              }`}>
              {isTextMessage && (
                <div>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700/50 bg-gradient-to-t from-white to-gray-50 dark:to-gray-900/50 backdrop-blur-sm">
        <form onSubmit={handleSend} className="flex items-end space-x-3">
          ...
          <div className="relative flex-shrink-0">
            <button
              ...
              className={`p-3 rounded-xl transition-all duration-200 ${showAttachments
                ...
                : 'text-gray-600 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-200 dark:text-gray-200'
                }`}
            >
          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            <button
              type="button"
              className="p-3 rounded-xl text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-200 transition-all"
            >
              <EmojiIcon />
            </button>
