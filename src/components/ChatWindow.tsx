...
export default function ChatWindow({ conversationId, conversationName, participants }: ChatWindowProps) {
        ...
        <div className={`max-w-[85%] sm:max-w-xs lg:max-w-md ${isOwnMessage ? 'order-2' : 'order-1'}`}>
          ...
          <div className={`relative group ${isOwnMessage ? 'ml-auto' : 'mr-auto'}`}>
            ...
            {isOwnMessage && isTextMessage && (
              <div className="absolute -left-10 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-1.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 dark:text-gray-300"
                  title="Opciones"
                >
                ...
                <AnimatePresence>
                  {messageMenuOpen === message._id && (
                    <motion.div
                      ...
                      className="absolute left-0 top-full mt-1 bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 py-1 z-50 min-w-[160px]"
                    >
                      <button
                        onClick={() => handleEditMessage(message._id, message.content.text || '')}
                        className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-800 dark:bg-gray-800 flex items-center space-x-2"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`px-3 sm:px-4 py-2 rounded-2xl shadow-sm dark:shadow-gray-900/50 ${isOwnMessage
              ...
              : 'bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 dark:border-gray-700 text-gray-900 dark:text-gray-100 dark:text-gray-100 dark:text-gray-100'
              }`}>
              {isTextMessage && (
                <div>
                  {editingMessageId === message._id ? (
                    ...
                    <div className="space-y-2">
                      <input
                        ...
                        className="w-full px-2 py-1 text-xs sm:text-sm border border-white/20 rounded bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/10 text-white placeholder-white/60"
                      ...
                      <div className="flex items-center space-x-2">
                        <button
                          ...
                          className="px-2 py-1 bg-white dark:bg-gray-900 dark:bg-gray-900 text-blue-600 text-xs rounded hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800"
                        >
                          Guardar
                        </button>
                        <button
                          onClick={handleCancelEdit}
                          className="px-2 py-1 bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/20 text-white text-xs rounded hover:bg-white dark:bg-gray-900/30"
                        >
                          Cancelar
                        </button>
                      </div>
              ...
              {isLocationMessage && (
                <div className="space-y-2">
                  <div className="bg-gray-100 dark:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 rounded-lg p-2 sm:p-3">
              ...
              <div className={`text-xs mt-1 ${isOwnMessage ? 'text-blue-100' : 'text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400'
                }`}>
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-none md:rounded-r-2xl shadow-lg">
      {/* Header mejorado del chat */}
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-gray-700/50 bg-gradient-to-r from-white to-gray-50 dark:to-gray-900/50 backdrop-blur-sm">
        <button
          onClick={handleHeaderClick}
          className="flex items-center space-x-3 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-800 dark:bg-gray-800 rounded-xl p-2 -m-2 transition-colors duration-200 group cursor-pointer"
          title="Ver perfil"
        >
          ...
          <div className="min-w-0">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 text-base truncate group-hover:text-blue-600 transition-colors">
              {conversationName || (() => {
                const otherParticipant = getOtherParticipant();
            ...
            <p className="text-xs flex items-center space-x-1">
              ...
              />
              <span className={isUserOnline ? 'text-green-600 font-medium' : 'text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400'}>
        ...
        <div className="flex items-center space-x-1 flex-shrink-0">
          <button className="p-2.5 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 transition-colors text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-blue-600">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {loading ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center p-6 max-w-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">¡Comienza la conversación!</h3>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-gray-700/50 bg-gradient-to-t from-white to-gray-50 dark:to-gray-900/50 backdrop-blur-sm">
        <form onSubmit={handleSend} className="flex items-end space-x-3">
          ...
          <div className="relative flex-shrink-0">
            <button
              ...
              className={`p-3 rounded-xl transition-all duration-200 ${showAttachments
                ...
                : 'text-gray-600 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 hover:text-gray-800 dark:text-gray-200 dark:hover:text-gray-200 dark:text-gray-200 dark:text-gray-200'
                }`}
            >
            ...
            <AnimatePresence>
              {showAttachments && (
                <motion.div
                  ...
                  className="absolute bottom-full left-0 mb-3 bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-gray-700/50 p-2 space-y-1 z-10 min-w-[180px]"
                >
          ...
          <div className="flex-1 min-w-0 relative">
            <textarea
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 resize-none text-base bg-gray-50 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800/50 hover:bg-white dark:bg-gray-900 dark:bg-gray-900 transition-all text-gray-900 dark:text-gray-100 dark:text-gray-100 placeholder:text-gray-500 dark:text-gray-400 dark:text-gray-500"
              rows={1}
              disabled={sending}
          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            <button
              type="button"
              className="p-3 rounded-xl text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 hover:text-gray-800 dark:text-gray-200 dark:hover:text-gray-200 dark:text-gray-200 transition-all"
            >
              <EmojiIcon />
            </button>
