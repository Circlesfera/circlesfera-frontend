          ...
          >
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={handleClose}
                  className="p-2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:bg-white dark:bg-gray-900/50 rounded-lg transition-colors"
                >
            ...
            <div className="p-6">
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm !text-gray-900 dark:text-gray-100 !placeholder-gray-500 dark:placeholder-gray-400 bg-white dark:bg-gray-900"
            ...
            <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              <div className="flex gap-3">
                <button
                  onClick={handleClose}
                  className="flex-1 px-4 py-2.5 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl font-medium hover:bg-gray-50 dark:bg-gray-800 transition-colors"
                >
                  Cancelar
                </button>
                <button
