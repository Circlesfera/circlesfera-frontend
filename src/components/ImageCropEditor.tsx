      ...
      <div className="flex items-center justify-center space-x-2 p-4 bg-black/30">
        <motion.button
          ...
          className={`px-6 py-3 rounded-lg transition-all ${aspectRatio === '1:1'
            ...
            : 'bg-white dark:bg-gray-900/10 text-white hover:bg-white dark:bg-gray-900/20'
            }`}
        >
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/3 left-0 right-0 h-px bg-white dark:bg-gray-900/20" />
            <div className="absolute top-2/3 left-0 right-0 h-px bg-white dark:bg-gray-900/20" />
            <div className="absolute left-1/3 top-0 bottom-0 w-px bg-white dark:bg-gray-900/20" />
            <div className="absolute left-2/3 top-0 bottom-0 w-px bg-white dark:bg-gray-900/20" />
          </div>
        </div>
      </div>
      ...
      <div className="p-6 bg-black/50 backdrop-blur-sm space-y-4 max-h-[40vh] overflow-y-auto">
        ...
        <div>
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              disabled={zoom <= 1}
              className="p-2 bg-white dark:bg-gray-900/10 hover:bg-white dark:bg-gray-900/20 rounded-full transition-colors disabled:opacity-30"
            >
            ...
            <input
              ...
              className="flex-1 h-2 bg-white dark:bg-gray-900/20 rounded-full appearance-none cursor-pointer
                [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4
                [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white dark:bg-gray-900"
            />
        ...
        <div className="flex items-center justify-center space-x-4">
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-white dark:bg-gray-900/10 hover:bg-white dark:bg-gray-900/20 rounded-lg transition-colors text-white"
          >
