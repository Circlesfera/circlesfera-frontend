    ...
    <div className="relative" ref={menuRef}>
      {following ? (
        <button
          onClick={handleClick}
          disabled={loading}
          className="text-xs font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:text-gray-100 transition-colors disabled:opacity-50"
        >
          {loading ? '...' : 'Siguiendo'}
        </button>
      ) : (
      ...
      {showMenu && following && (
        <div className="absolute top-full right-0 mt-2 w-56 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 py-2 z-50 overflow-hidden">
          <button
