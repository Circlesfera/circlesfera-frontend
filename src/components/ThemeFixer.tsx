      ...
      <div className="bg-white dark:bg-gray-900 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-lg p-3 shadow-lg">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={isFixing}
            className="px-2 py-1 bg-gray-100 dark:bg-gray-700 dark:bg-gray-700 text-gray-900 dark:text-gray-100 dark:text-gray-100 text-xs rounded hover:bg-gray-200 dark:hover:bg-gray-600 disabled:opacity-50"
          >
            ☀️ Light
          </button>
        </div>
