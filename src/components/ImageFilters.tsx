  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-3 bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/5 hover:bg-white dark:bg-gray-900/10 rounded-lg transition-colors text-white"
      >
