      ...
      <form onSubmit={onSearchSubmit} role="search">
        <div className="relative">
          <input
            ...
            onBlur={onSearchBlur}
            className={`w-full pl-12 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-center text-sm text-gray-900 placeholder-gray-500 focus-visible:outline-none focus-visible:border-blue-500 focus-visible:bg-white focus-visible:shadow-lg transition-all duration-200 ${searchFocused ? 'border-blue-400 bg-white shadow-lg' : 'hover:border-gray-300'
              }`}
