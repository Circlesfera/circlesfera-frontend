  ...
  return (
    <div className="hidden md:block w-72 relative" ref={searchRef}>
      ...
      {showSearch && searchQuery && (
        <div
          className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 max-h-96 overflow-y-auto z-50 animate-fade-in"
          role="region"
