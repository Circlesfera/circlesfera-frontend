...
export function DesktopNavigation({
  ...
  return (
    <nav className="hidden md:flex items-center gap-1 lg:gap-2" role="navigation" aria-label="Navegación principal">
      ...
      <Link
        href="/"
        className={`${TOUCH_TARGET_CLASSES.min} p-2 lg:p-3 hover:bg-gray-100 rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 group`}
      ...
      <Link
        href="/notifications"
        className={`${TOUCH_TARGET_CLASSES.min} relative p-2 lg:p-3 hover:bg-gray-100 rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 group`}
