        ...
        >
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* Tu Video */}
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Tu Reacción</h3>
                {preview ? (
                  ...
                  >
                    ...
                    <p className="text-gray-600 font-medium">Sube tu reacción</p>
                    <p className="text-sm text-gray-500 mt-2">El clip se mostrará primero</p>
