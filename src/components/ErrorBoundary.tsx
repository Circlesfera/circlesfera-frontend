          ...
          <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="mb-6 text-left">
                ...
                <div className="bg-gray-100 dark:bg-gray-900 rounded p-4 text-xs overflow-auto max-h-48">
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="px-6 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors font-medium"
              >
                Intentar de nuevo
              </button>
