    ...
    return (
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 sm:gap-3 lg:gap-4">
        {safeContent.map((story) => (
          <div key={story.id} className="aspect-square rounded-xl sm:rounded-2xl overflow-hidden bg-gradient-to-br from-purple-400 to-pink-400 relative group cursor-pointer">
            <Image
              src={(story as any).content?.image?.url || '/placeholder.png'}
              alt="Story"
              fill
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4">
      {safeContent.map((item) => {
        ...
        return (
          <div key={item.id} className="aspect-square rounded-xl sm:rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-700 dark:bg-gray-800 relative group cursor-pointer">
            {type === 'posts' ? (
              <Image
