...
import { createImagePost, createVideoPost } from '@/features/posts/services/postService';
              ...
              >
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <motion.div
                    ...
                    className={`w-16 h-16 rounded border-2 ${aspectRatio === '1:1' ? 'border-blue-500 bg-blue-100' : 'border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800'
                      }`}
                  />
                  <div className="text-center">
                    <div className={`font-semibold ${aspectRatio === '1:1' ? 'text-blue-700' : 'text-gray-700 dark:text-gray-300'}`}>
                      Cuadrado
                    </div>
                    <div className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">1:1</div>
                  </div>
                  <AnimatePresence>
                    {aspectRatio === '1:1' && (
                      <motion.div
              ...
              >
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                    className={`w-12 h-16 rounded border-2 ${aspectRatio === '4:5' ? 'border-blue-500 bg-blue-100' : 'border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800'
                      }`}
                  />
                  <div className="text-center">
                    <div className={`font-semibold ${aspectRatio === '4:5' ? 'text-blue-700' : 'text-gray-700 dark:text-gray-300'}`}>
                      Vertical
                    </div>
                    <div className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">4:5</div>
                  </div>
                  <AnimatePresence>
                    {aspectRatio === '4:5' && (
                      <motion.div
        ...
        <form onSubmit={handleSubmit}>
            ...
            {!preview ? (
              <div
                className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${isDragOver
                  ...
                  : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:border-gray-500'
                  }`}
          ...
          <div className="mb-4">
            <div className="flex items-center space-x-2 mb-2">
              <TextIcon />
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">¿Qué quieres compartir?</span>
            </div>
            <textarea
              value={text}
              ...
              maxLength={5000}
            />
            <div className="text-right text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">
          ...
          <div className="flex justify-end space-x-3">
            <button
              type="button"
              onClick={resetForm}
              className="px-6 py-2 text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:text-gray-200 dark:hover:text-gray-200 transition-colors"
              disabled={loading}
            >
              Cancelar
            </button>
