...
export function PostCardActions({
  ...
  const postUrl = `${typeof window !== 'undefined' ? window.location.origin : ''}/${post.user?.username || 'usuario'}/post/${post.id}`
    ...
    <div className="px-6 py-3">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          ...
          {/* Comment button */}
          <button
            onClick={() => onComment?.(post.id, post.user?.username || 'usuario', post.content?.media?.[0]?.url)}
          ...
          {/* Share button */}
          <button
            onClick={() => onShare?.(post.id, postUrl, post.caption)}
            className={`${TOUCH_TARGET_CLASSES.min} p-2 rounded-full hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2`}
                ...
                {post.caption.length > 80 && !showFullCaption ? (
                  <>
                    ...
                    <button
                      ...
                      className="text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 dark:text-gray-300 ml-1 font-medium focus-visible:outline-none focus-visible:underline"
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gray-200 dark:bg-gray-600 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 transition-colors"
      ...
      {post.tags && post.tags.length > 0 && (
        <div className="flex items-center space-x-1 mt-2" role="list" aria-label="Tags del post">
          <TagIcon aria-hidden="true" className="text-gray-400 dark:text-gray-500 dark:text-gray-400" />
