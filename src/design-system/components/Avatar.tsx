...
const Avatar = forwardRef<HTMLDivElement, AvatarProps>(
  ({
    ...
    const baseClasses = `
      ...
      bg-gray-200 dark:bg-gray-600 dark:bg-gray-700 text-gray-600 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 font-medium
      select-none
    `;
      ...
      >
        {src ? (
          <Image
            ...
            onError={() => {
              // El manejo de errores se hace en Image
            }}
          />
        ) : null}
