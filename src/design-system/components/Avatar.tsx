...
const Avatar = forwardRef<HTMLDivElement, AvatarProps>(
  ({
    ...
    const baseClasses = `
      ...
      bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400 dark:text-gray-500 font-medium
      select-none
    `;
    ...
    return (
      ...
      >
        ...
        {remainingCount > 0 && (
          <div
            className={cn(
              'relative inline-flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 dark:text-gray-500 font-medium border-2 border-white',
