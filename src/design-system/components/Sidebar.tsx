...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className={cn(
        "hidden lg:flex flex-col w-64 h-screen bg-white border-r border-gray-200 fixed left-0 top-0 z-40",
        className
      )}>
        {/* Logo */}
        <div className="p-6 border-b border-gray-200">
          <Link href="/" className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-gray-900">CircleSfera</span>
          </Link>
        </div>
