...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({
    ...
    const variants = {
      ...
      ghost: 'text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 focus:ring-gray-200',
