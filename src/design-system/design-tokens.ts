...
export const utilityClasses = {
  ...
  btn: {
    ...
    `,
    secondary: `
      bg-white dark:bg-gray-900 dark:bg-gray-900 text-gray-700 dark:text-gray-300 dark:text-gray-300 font-medium px-6 py-3 
      rounded-xl border-2 border-gray-200 dark:border-gray-700 dark:border-gray-700 
      hover:border-gray-300 dark:border-gray-600 dark:border-gray-600 hover:shadow-lg 
      transition-all duration-300 ease-out 
      hover:scale-105 active:scale-95
      focus:outline-none focus:ring-4 focus:ring-gray-200
    `,
    ghost: `
      text-gray-600 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 font-medium px-4 py-2 
      rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:bg-gray-800 
  ...
  input: `
    w-full px-4 py-3 
    border-2 border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl 
  ...
  // Cards
  card: `
    bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-2xl shadow-lg 
  ...
  // Text
  text: {
    heading: 'text-gray-900 dark:text-gray-100 dark:text-gray-100 font-semibold',
    body: 'text-gray-700 dark:text-gray-300 dark:text-gray-300',
    caption: 'text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 text-sm',
